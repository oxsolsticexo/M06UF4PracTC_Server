...
public class AppSingletonEJB {
    ...
    private static final String DATE_VERSION = "05/05/2023";
    ...
    private void showLogo() {
        ...
        banner.append(System.lineSeparator());
        banner.append("Versió del servidor: ").append(AppSingletonEJB.APP_VERSION).append(" de " + AppSingletonEJB.DATE_VERSION);
        banner.append(System.lineSeparator());
    ...
    private void getQuestions() {
        ...
        String fileName = File.separator + "files" + File.separator + "preguntas.xml";
        ...
        try {
            ...
            convertInputStringToText(input);
    ...
    public void convertInputStringToText(InputStream inputStream) throws IOException {
